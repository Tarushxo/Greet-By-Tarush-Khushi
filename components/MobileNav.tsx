...
const MobileNav = () => {
  ...
  return (
        <section className='w-full max-w-[264px]'>
            <Sheet>
                <SheetTrigger asChild><Image src="/icons/hamburger.svg" alt="menu" width={36} height={36} className="cursor-pointer sm:hidden" /></SheetTrigger>
                ...
                <div className='flex-h-[calc(100vh-72pk)] flex-col justify-between overflow-y-auto'>
                    <SheetClose asChild>
